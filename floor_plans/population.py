...
from floor_plans.reporting import ReporterSet, StatisticsReporter, StdOutReporter
from floor_plans.species import Species
...
class Population(object):
    ...
    def save_checkpoint(self, filename=None, checkpoint_type="user"):
        ...
        if filename is None:
            filename = 'floor_plans-checkpoint-{0}'.format(self.generation)
